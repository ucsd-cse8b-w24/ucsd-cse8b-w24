...
If you get stuck at any point, do any one of the following:
  ...
  - [Ask for help!](https://ucsd-cse8b-w24.github.io/help-hours.html)
...
1. A code submission of your program with the methods you wrote for part two, at [PA1 gradescope assignment](https://www.gradescope.com/courses/696682/assignments/3902544/). You should select and upload the files `DesignRecipeExamples.java`, `CompileTimeErrors.java` and `transcript.txt`
